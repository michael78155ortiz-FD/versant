...
export default function ProfileScreen({ navigation }: any) {
  ...
  async function handleSave() {
    ...
    if (error) {
      ...
      if (Platform.OS === 'web') {
        window.alert('Saved ✓ Your profile has been updated.')
      } else {
  ...
  async function handleAddPhoto() {
    if (photos.length >= 3) {
      if (Platform.OS === 'web') {
        window.alert('You can have up to 3 photos.')
      } else {
        Alert.alert('Max photos', 'You can have up to 3 photos.')
      }
      return
    }
    ...
    if (!permission.granted) {
      if (Platform.OS === 'web') {
        window.alert('Please allow access to your photos.')
      } else {
    ...
    if (!result.canceled && result.assets[0]) {
      ...
      try {
        ...
        if (Platform.OS === 'web') {
          window.alert('Photo added ✓')
        } else {
          Alert.alert('Photo added ✓')
        }
      } catch (err: any) {
        if (Platform.OS === 'web') {
          window.alert('Failed to upload photo: ' + err.message)
        } else {
  ...
  async function handleDeleteAccount() {
    if (Platform.OS === 'web') {
      const confirmed = window.confirm(
        '⚠️ This will permanently delete your account, all pods, messages, and matches.\n\nThis cannot be undone. Are you absolutely sure?'
      )
      if (!confirmed) return

      const doubleConfirm = window.confirm(
        'Last chance — delete everything forever?'
      )
      ...
      Alert.alert(
        '⚠️ Delete Account',
        'This will permanently delete your account, all your pods, messages, and matches. This cannot be undone.',
        [
          { text: 'Cancel', style: 'cancel' },
          {
            text: 'Delete Forever',
      ...
      >
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>
            My Photos
            <Text style={styles.sectionSub}> · hidden until reveal</Text>
          </Text>
                  ...
                  >
                    {uploadingPhoto && index === photos.length ? (
                      ...
                      <>
                        ...
                        <Text style={styles.photoEmptyLabel}>
          ...
          <Text style={styles.photoHint}>
            🔒 Photos hidden until both agree to reveal
          </Text>
        </View>
        ...
        <View style={styles.matchBox}>
          <View style={styles.matchBoxLeft}>
            <Text style={styles.matchBoxTitle}>Active Matches</Text>
            <Text style={styles.matchBoxSub}>
              Unmatch someone to open a new spot
            </Text>
          </View>
          ...
          {[
            {
              ...
              sub: quizCompleted ? 'Retake your quiz' : 'Complete your quiz',
              screen: 'Quiz',
            },
            {
              icon: '✈️',
        ...
        <Text style={styles.deleteWarning}>
          ...
          All your data, pods, and matches will be removed forever.
        </Text>
