...
const ATTACHMENT_OPTIONS = [
  {
    value: 'secure',
    label: 'I feel comfortable with closeness and independence equally',
    emoji: '💚',
  },
  {
    value: 'anxious',
    label: 'I tend to worry about my partner pulling away',
    emoji: '💛',
  },
  {
    value: 'avoidant',
    label: 'I value independence and sometimes feel crowded',
    emoji: '🔵',
  },
  {
    value: 'disorganized',
    label: 'I want closeness but it sometimes feels scary',
    emoji: '🔴',
  },
]
...
const DEALBREAKER_OPTIONS = [
  ...
  { value: 'wantsKidsNow', label: 'Wants kids immediately', emoji: '⏰' },
  { value: 'longDistance', label: 'Long distance', emoji: '✈️' },
  { value: 'noMarriage', label: 'Against marriage', emoji: '💍' },
]

const LOOKING_FOR_OPTIONS = [
  { value: 'longTermRelationship', label: 'Long-term relationship', emoji: '💑' },
  { value: 'marriage', label: 'Marriage', emoji: '💍' },
  { value: 'buildingFamily', label: 'Building a family', emoji: '👨‍👩‍👧' },
  { value: 'deepConnection', label: 'Deep connection', emoji: '🔗' },
  { value: 'companionship', label: 'Companionship', emoji: '🤝' },
]
...
const STEP_SUBTITLES = [
  'Pick 3–5 that matter most to you',
...
export default function QuizScreen({ navigation }: any) {
  ...
  async function handleFinish() {
    ...
    const quizAnswers = {
      ...
      lifeVision,
      kidsChoice,
      kidsInvolvement: independenceLevel,
      moneyStyle,
      locationFlex,
      loveLanguage,
      independenceLevel,
      ...
      case 0:
        return (
          <ChipGrid
            ...
            selected={values}
            onToggle={v => toggleMulti(v, values, setValues, 5)}
            hint="Choose 3 to 5"
          />
        )
      case 1:
        return (
          <SingleSelect
            options={LIFE_VISION_OPTIONS}
            selected={lifeVision}
            onSelect={setLifeVision}
          />
        )
      case 2:
        return (
      ...
      case 4:
        return (
          <SingleSelect
            ...
            selected={locationFlex}
            onSelect={setLocationFlex}
          />
        )
      case 5:
        return (
      ...
      case 6:
        return (
          <SliderStep
            ...
            leftLabel="Always together"
            rightLabel="Lots of alone time"
            value={independenceLevel}
            onValueChange={setIndependenceLevel}
          />
        )
      case 7:
        return (
          <ChipGrid
            ...
            onToggle={v => toggleMulti(v, dailyHabits, setDailyHabits, 6)}
      ...
      case 9:
        return (
          <ChipGrid
            ...
            selected={growthMindset}
            onToggle={v => toggleMulti(v, growthMindset, setGrowthMindset, 4)}
            hint="Select all that apply"
          />
        )
      case 10:
        ...
        return (
          <View style={{ gap: 12 }}>
            <ChipGrid
              ...
              onToggle={v =>
                toggleMulti(v, dealbreakers, setDealbreakers, 9)
              }
            ...
            <View style={styles.aboutSection}>
              <Text style={styles.aboutLabel}>
                About me{' '}
                <Text style={styles.aboutOptional}>(optional)</Text>
              </Text>
              <TextInput
        ...
        {step >= 6 && (
          <View style={styles.encourageBox}>
            <Text style={styles.encourageText}>
              {step < 10
                ? `You're doing great — ${TOTAL_STEPS - step - 1} left!`
                : "Almost done — you're building something real 💛"}
            </Text>
          </View>
        )}
        ...
        return (
          ...
          >
            ...
            <Text
              style={[
                styles.singleLabel,
                isSelected && styles.singleLabelSelected,
              ]}
            >
              {opt.label}
            </Text>
          ...
          >
            <Text
              style={[
                ...
                value === n && styles.sliderDotTextActive,
              ]}
            >
              {n}
            </Text>
        ...
        return (
          <TouchableOpacity
            ...
            style={[
              ...
              isSelected && styles.attachmentOptionSelected,
            ]}
            onPress={() => onSelect(opt.value)}
          >
            <Text style={styles.attachmentEmoji}>{opt.emoji}</Text>
            <Text
              style={[
                styles.attachmentLabel,
                isSelected && styles.attachmentLabelSelected,
              ]}
            >
              {opt.label}
            </Text>
            {isSelected && (
              <View style={styles.attachmentCheck}>
                <Text style={styles.attachmentCheckText}>✓</Text>
              </View>
            )}
          </TouchableOpacity>
        )
